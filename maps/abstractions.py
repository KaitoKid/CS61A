...
""" Trying to fix abstraction barrier...
def restaurant_lat(restaurant):
    return restaurant['lat']
def restaurant_longi(restaurant):
    return restaurant['longi']
"""
...
def restaurant_ratings(restaurant):
    ...
    # BEGIN Question 1
    return [review_rating(n) for n in restaurant_review(restaurant)]
    # END Question 1
...
def restaurant_mean_rating(restaurant):
    ...
    # BEGIN Question 2
    list_of_rating = restaurant_ratings(restaurant)
    return sum(list_of_rating)/restaurant_num_ratings(restaurant)
    # END Question 2
